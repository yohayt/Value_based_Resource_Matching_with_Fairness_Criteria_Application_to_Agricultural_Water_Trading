...
def main():
    ...
    touchet = pd.read_csv('touchet/Touchet_statistics_by_water_capacity.csv')
    yakima = pd.read_csv('yakima/Yakima_statistics_by_water_capacity.csv')
    ...
    dashes = [(2, 2), (2, 2), (2, 2), (2, 0), (2, 0), (2, 0)]
    ...
    ax = plot.subplot(fig=fig, grid=gs[0, 8:11], func='sns.lineplot',
                      ...
                      pf_dashes=dashes,
                      pf_linewidth=3,
                      ag_xmin=0, ag_xmax=1, ag_ymin=0,ag_ymax=4000000,
                      lg_visible=False,
                      la_title='(d)',
                      fs_title='normalsize',
                      la_xlabel=f'$\delta$',
